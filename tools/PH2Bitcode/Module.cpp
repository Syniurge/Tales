...
void Module::addNamedStructType(StringRef Name, StructType* Ty) {
  StringMap<StructType *> &SymbolTable = this->NamedStructTypes;
  typedef StringMap<StructType *>::MapEntryTy EntryTy;

  // Look up the entry for the name.
  EntryTy *Entry = &SymbolTable.GetOrCreateValue(Name);

  // Name collision, shouldn't happen for Tales
  if (Entry->getValue())
    errs() << "Struct name collision: shouldn't happen!\n";
