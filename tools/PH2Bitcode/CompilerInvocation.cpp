...
static bool ParseCodeGenArgs(CodeGenOptions &Opts, ArgList &Args, InputKind IK,
  ...
  // Tales
  SmallString<256> InputConstraint(Args.getLastArgValue(OPT_input_constraint));
  llvm::sys::fs::make_absolute(InputConstraint);
  Opts.InputConstraint = InputConstraint.str();
