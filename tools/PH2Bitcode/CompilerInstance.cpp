...
void CompilerInstance::createSema(TranslationUnitKind TUKind,
  ...
  // For Tales (HACK-ish? this seems to be the proper place to pass options to Sema)
  TheSema->PHFileName = getFrontendOpts().PHFileName;
  llvm::errs() << "Passing PHFileName to Sema (" << TheSema->PHFileName << ")\n";
}
