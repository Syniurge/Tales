...
public:
  ...
  ///
  typedef StringMap<StructType*>::iterator                        struct_iterator;
  ///
  typedef StringMap<StructType*>::const_iterator            const_struct_iterator;
...
private:
  ...
  StringMap<StructType*> NamedStructTypes;      ///< The struct types that need to be saved in IR/bitcode files (NOTE: for Tales)
...
/// @}
/// @name Named Struct Accessors (Tales)
/// @{

  /// getNamedMetadata - Return the NamedMDNode in the module with the
  /// specified name. This method returns null if a NamedMDNode with the
  /// specified name is not found.
  void addNamedStructType(StringRef Name, StructType* Ty);
...
/// @}
/// @name Struct Type Iteration (Tales)
/// @{

  struct_iterator       struct_begin()            { return NamedStructTypes.begin(); }
  const_struct_iterator struct_begin() const      { return NamedStructTypes.begin(); }
  struct_iterator       struct_end  ()            { return NamedStructTypes.end();   }
  const_struct_iterator struct_end  () const      { return NamedStructTypes.end();   }
  size_t                struct_size () const      { return NamedStructTypes.size();  }
  bool                  struct_empty() const      { return NamedStructTypes.empty(); }
