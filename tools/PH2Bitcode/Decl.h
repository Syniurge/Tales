...
class NamedDecl : public Decl {
  ...
  /// For Tales!
  /// Whilelisted - That declaration was whitelisted by the pseudo-headers parsing
  /// pass for being "bound" by Tales. At the end of the parsing, a modified Codegen
  /// pass will generate external function declarations and struct with tagged members
  /// for every whitelisted declaration in the AST.
  bool Whitelisted;

  /// IsLate - Functions and variables are revisited at the end of the translation unit
  /// so that their types are properly instanciated before being emitted.
  bool IsLate;
...
protected:
  NamedDecl(Kind DK, DeclContext *DC, SourceLocation L, DeclarationName N)
    : Decl(DK, DC, L), Name(N), Whitelisted(false), IsLate(false) { }
...
public:
  ...
  bool isLate() const { return IsLate; }
  void setLate(bool IL) { IsLate = IL; }
